...
class Api::V1::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_user" do
    assert_difference('Api::V1::User.count') do
      post api_v1_users_url, params: { api_v1_user: { age: @api_v1_user.age, city: @api_v1_user.city, contact: @api_v1_user.contact, name: @api_v1_user.name, user_type: @api_v1_user.user_type } }
    end
  ...
  test "should update api_v1_user" do
    patch api_v1_user_url(@api_v1_user), params: { api_v1_user: { age: @api_v1_user.age, city: @api_v1_user.city, contact: @api_v1_user.contact, name: @api_v1_user.name, user_type: @api_v1_user.user_type } }
